package com.derpcprofi.springboot.controller;
...
import com.derpcprofi.springboot.Application;
...
public class SurveyControllerIT {
	...
	public void testRetrieveSurveyQuestion() {
		...
		String expected = "{id:Question1,description:Größtes Land der Welt,correctAnswer:Russia}";
